...
async def get_student_data(client, roll_no):
    """
...
async def main():
    ...
    async with httpx.AsyncClient() as client:
        tasks = [get_student_data(client, roll_no.strip()) for roll_no in roll_numbers]
        results = await asyncio.gather(*tasks)

    # Write data to Excel for each roll number
